    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      >
        ...
        <nav className="flex-1 p-4 space-y-2">
          <Button variant="ghost" className={`w-full justify-start ${!sidebarOpen && "justify-center px-0"}`}>
          ...
          <div className="flex flex-col space-y-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <a href="/email" className="text-primary hover:text-primary-600 font-medium">
                  Try it now →
                </a>
              </div>
                ...
                {[1, 2, 3].map((item) => (
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-300 mb-2">
                      Weekly project status and upcoming deadlines for the marketing campaign...
                    </div>
